...
library(dplyr)
library(magrittr)
source("/shared/hidelab2/user/md4zsa/Work/diffcoexp/diffcoexp.R")
synapseLogin()
#cl=makeCluster(8)
...
rosmap_diffcoexp=diffcoexp(exprs.1 = rosmap_c_counts,exprs.2 = rosmap_t_counts,rth=0.0, qth=0.1, r.diffth=0.0, q.diffth=0.1)
