...
msbb_ifg_DiffCoexp=diffcoexp(exprs.1 = msbb_ifg_c_counts,exprs.2 = msbb_ifg_t_counts,rth=0.6, qth=0.1, r.diffth=0.1, q.diffth=0.1)
...
saveRDS(msbb_ifg_DiffCoexp,"MSBB_IFG_DiffCoexp_noLFC_bugfix2.res.RDS")
saveRDS(msbb_ifg_DRsort,"MSBB_IFG_DRsort_noLFC_bugfix2.res.RDS")
