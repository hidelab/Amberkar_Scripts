...
rosmap_reseq_data.agg=readRDS("rosmap_reseq_data_agg.RDS")
...
rosmap_cogdx2.counts=rosmap_reseq_data.agg[,rosmap_covariates%>%dplyr::filter(SampleType=="COGDX4")%>%dplyr::pull(SampleID)]
...
saveRDS(rosmap_diffcoexp,"ROSMAP_Ctrl_Cogdx4_diffcoexp_results.RDS")
