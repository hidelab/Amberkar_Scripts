...
c_counts=msmm_data2.agg[,which(colnames(msmm_data2.agg)%in%msmm_reseq_design_matrix$SampleID[msmm_reseq_design_matrix$BrainRegion.DiagnosisPHG.CONTROL==1])]
t_counts=msmm_data2.agg[,which(colnames(msmm_data2.agg)%in%msmm_reseq_design_matrix$SampleID[msmm_reseq_design_matrix$BrainRegion.DiagnosisPHG.AD==1])]
n.c<-ncol(c_counts)
n.t<-ncol(t_counts)
