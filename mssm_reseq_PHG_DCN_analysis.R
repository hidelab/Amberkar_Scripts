...
c_exprs_rank=msmm_data[,which(colnames(msmm_data)%in%msmm_reseq_design_matrix$SampleID[msmm_reseq_design_matrix$BrainRegion.DiagnosisPHG.CONTROL==1])]
t_exprs_rank=msmm_data[,which(colnames(msmm_data)%in%msmm_reseq_design_matrix$SampleID[msmm_reseq_design_matrix$BrainRegion.DiagnosisPHG.AD==1])]
