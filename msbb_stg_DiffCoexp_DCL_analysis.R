...
library(dplyr)
library(magrittr)
source("/shared/hidelab2/shared/wenbin/diffcoexp.R")
synapseLogin()
# cl=makeCluster(8)
...
msbb_stg_DiffCoexp=diffcoexp(exprs.1 = msbb_stg_c_counts,exprs.2 = msbb_stg_t_counts,rth=0.6, qth=0.1, r.diffth=0.6, q.diffth=0.1)
